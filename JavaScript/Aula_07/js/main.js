...
let pessoa = {
  ...
  idade: 10,
  corDosOlhos: "preto",
  hobbies: ["música", "filmes", "esportes", "objetos"],
  endereco: {
    rua: "Rua do bobos",
    numero: 0,
    cidade: "São Paulo",
...
console.log(pessoa.hobbies[1][4]);
...
let tarefa_JSON =
    ...
    '{"id":2,"texto":"Encontrar com ochefe","isCompleted":true},';
  '{"id":3,"texto":"Consulta nodentista","isCompleted":false}]';
